...
export class AuthService {
  ...
  public getToken(): string {
    ...
    sessionStorage.setItem('userCash', '0');
    return '';
  }
  ...
  private getUserCash() {
    this._webApiObservable.getCash().subscribe(resp => {
      sessionStorage.setItem('userCash', resp.toString());
    }, err => {
      console.log(err);
    });
  }
  ...
  public userCash() {
    return this._webApiObservable.getCash();
  }
